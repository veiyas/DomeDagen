...
void initOGL(GLFWwindow*) {
	...
	GameObject* temp1 = new SceneObject(GameObject::SCENEOBJECT, "fish", glm::vec3(0.f, 20.f, 0.f), 0.f);
	GameObject* temp2 = new Player(GameObject::PLAYER, "fish", glm::vec3(1.f), 0.f, "hejhej");
